                    ...
                    <div class="row" style="padding: 20px;">
                        <div class="col-md-6">
                            <div class="form-group">
                                <h4 for="" style="margin-bottom: 2rem;"><b>Details</b></h4>
                                ...
                                <select class="form-control" id="incharge" name="incharge">
                                ...
                                <select class="form-control" id="category" name="category">
                                    <option value="Category 1">NG Picture</option>
                                    <option value="Category 2">Meeting Picture</option>
                                    <option value="Category 3">Event Picture</option>
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="drag-area">
                                    ...
                                    <input type="file" style="display:none;" name="my_file" id="fileToUpload" accept=".jpg, .jpeg, .png, .mp3, .mp4, .pdf" />
...
<script>
    ...
    const fileExtension = document.getElementById("fileExtension"); // added
    const selectedFileName = document.getElementById("selectedFileName"); 

    let button = dropArea.querySelector(".button");
    const input = document.getElementById("fileToUpload"); // Reference to the file input element
    let today = new Date();
    let formattedDate = today.toISOString().split('T')[0];

    function displayFile() {
    let fileType = file.type;
    let fileName = file.name; // Added this line to get the file name
    let fileExtensionText = fileName.split('.').pop().toUpperCase(); // Get file extension and convert to uppercase
    fileExtension.textContent = fileExtensionText; // D
    ...
    fileInput.addEventListener("change", function () {
        ...
        if (file) {
            ...
            if (validExtensions.includes(fileType)) {
                ...
                selectedFilePreview.innerHTML = ""; // Clear the preview
            }
        } else {
            selectedFilePreview.innerHTML = ""; // Clear the preview if no file is selected
        }
    });
